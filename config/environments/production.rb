Rails.application.configure do
  ...
  # Send me emails with any exceptions that might occur
  config.middleware.use ExceptionNotification::Rack,
    email: {
      email_prefix:         '[glasatni error] ',
      sender_address:       %("glasatni" <errors@errors.glasatni.bg>),
      exception_recipients: %w(petko.tsikov@obshtestvo.bg)
    }
end
