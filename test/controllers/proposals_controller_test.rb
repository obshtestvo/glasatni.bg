...
class ProposalsControllerTest < ActionController::TestCase
  ...
  test "should create proposal" do
    assert_difference('Proposal.count') do
      post :create, proposal: { content: @proposal.content, down: @proposal.down, theme_id: @proposal.theme_id, title: @proposal.title, up: @proposal.up }
    end
  ...
  test "should update proposal" do
    patch :update, id: @proposal, proposal: { content: @proposal.content, down: @proposal.down, theme_id: @proposal.theme_id, title: @proposal.title, up: @proposal.up }
    assert_redirected_to proposal_path(assigns(:proposal))
  end
